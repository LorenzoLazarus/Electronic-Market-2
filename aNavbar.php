...
?>
  ...
  <body>
      ...
      <div class="wrapper d-flex align-items-stretch" style="background-color: #whitesmoke">
			<nav id="sidebar">
				<div class="p-4 pt-5">
		  		<a href="#" class="img logo rounded-circle mb-5" style="background-image: url(Media/ecommerce1.jpg);"></a>
                                ...
                                <span style="text-align: center;"><h1 style="font-size: 25px;color: #ff8417;">Admin</h1></span>                                                                    					
                                <hr style="border: solid 0.5px #ff8417">
                                <br>
	        <ul class="list-unstyled components mb-5">
	          <li class="active">
                ...
                <li>
                    <a href="#">Manager Accounts</a>
                </li>                                                
	            </ul>
	          </li>	  
                  <li>
	              <a href="#Stock" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">Manage Stock</a>
                      <ul class="collapse list-unstyled" id="Stock">
                <li>
                    <a href="#">View Stock</a>
                </li>               
                <li>
                    <a href="#">Add/Edit Stock</a>
                </li>                                                
	            </ul>
	          </li>	  
                   <li>
