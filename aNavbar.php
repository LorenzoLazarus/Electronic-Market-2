        ...
        <nav id="sidebar">
            <div class="p-4 pt-5">
                ...
                <span style="text-align: center;">
                    <h1 style="font-size: 35px;color: whitesmoke;font-weight: bold;">eCommerce</h1>
                </span>
                <hr style="border: solid 0.6px #ff8417">
                <hr style="border: solid 0.5px #ff8417">
                <span style="text-align: center;">
                    <h1 style="font-size: 25px;color: #ff8417;">Admin</h1>
                </span>
                <hr style="border: solid 0.5px #ff8417">
                <br>
                <ul class="list-unstyled components mb-5">
                    ...
                    <li>
                        <a href="aProductManagement.php">Manage Products</a>
                    </li>
                    <li>
