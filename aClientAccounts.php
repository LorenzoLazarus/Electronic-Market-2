...
<html lang="en">
    <head>
        ...
        <title>eCommerce |Client Accounts</title>
    </head>
    <body id="wrapper">
        ...
        <main role="main" >
            ...
            <div class="col-4 col-12-xsmall">
                <input type="submit" name="UpdateClient" value="Update Client" class="fit primary" />
            </div>

            <br><br>

            <div class="col-4 col-12-xsmall">
                <input type="submit" name="AddClient" value="Delete Client" class="fit primary" />
            </div>
